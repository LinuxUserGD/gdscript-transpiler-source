...
repl_dict = {
    ...
    "';xpython.__main__.main()'],stdout,true,false)": "sys.argv=['python',pathstr+'py']"
    + "\n"
    + "    stdout = [xpython.__main__.main()]",
    "';ziglang.__main__'],stdout,true,false)": "sys.argv=['zig','version']"
    + "\n"
    + "    import ziglang.__main__"
    + "\n"
    + "    stdout = [ziglang.__main__]",
    "';nuitka.__main__.main()'],stdout,true,false)": "import subprocess"
    + "\n"
    + "    x=sys.executable"
    + "\n"
    + "    xx="
...
BUILTIN_CLASSES = {
    ...
    # Maybe convert those to typesafe Godot s?
